...
class Profile(UUIDModel):
    ...
    gender = models.CharField(choices=GENDER_TYPES, max_length=16, blank=True)
    interests = ArrayField(models.CharField(choices=INTEREST_TYPES, max_length=32, blank=True), blank=True, default=list)
