...
## Project Structure
    ...
    ├── ideapros_llc_viaggi_32125  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_viaggi_32125`
...
2. Clone this repo and `cd ideapros_llc_viaggi_32125`
