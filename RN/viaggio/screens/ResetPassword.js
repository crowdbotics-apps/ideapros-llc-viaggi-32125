      ...
      <View style={styles.View_3}>
        ...
        <View style={styles.View_2}>
          ...
          <View style={styles.View_4}>
            <TextInput style={styles.TextInput_1} placeholder="Set new password" onChangeText={(UserEmail) => setUserEmail(UserEmail)} />
          ...
          <View style={styles.View_4}>
            <TextInput style={styles.TextInput_1} placeholder="Confirm new password" onChangeText={(UserEmail) => setUserEmail(UserEmail)} />
            <View style={styles.input_icon_view}>
              <ImageBackground source={require ('../assets/images/login_email_icon.png')} style={styles.ImageBackground_86_909_2} />
            </View>
          </View>
